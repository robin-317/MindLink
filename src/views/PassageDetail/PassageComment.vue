...
import { loadTopTopComment } from "@/api/get/getPasInfo";



//分页组件
const pagination = ref({currentPage: 1, pageSize: 24, passageId: route.params.passageId});
 ...
 * 发布/回复 评论
 */
import { postAddCommentApi } from "@/api/get/getPasInfo";
