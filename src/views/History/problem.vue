...
import { getHistoryTodayPInfo } from "@/api/history";
const getToday = async()=>{
  let res = await getHistoryTodayPInfo(loginStore.userInfo.id,2);
  if(res.code == 200){
    todayHistory.value = res.data;
  }
}
// const getYesterday = async()=>{
//   let res = await getHistoryYesterdayInfo(loginStore.userInfo.id,2);
//   if(res.code == 200){
//     yesterdayHistory.value = res.data;
//   }
// }
// const getWeek = async()=>{
//   let res = await getHistoryWeekInfo(loginStore.userInfo.id,2);
//   if(res.code == 200){
