...
//   return (videoInfo.value.interaction == null || videoInfo.value.interaction.indexOf("1")==-1)
// })
...
import { loadTopTopComment } from "@/api/get/getInfo";
// const loadCommentList =async()=>{
//   if(!showComment){
//     return;
//   }
//   const info ={
//     viewId:route.params.videoId,//所属视频
//     size: 1,
//     pageSize: 20,
//   }
//   loadingData = true;
//   let res = await loadTopTopComment(info);
//   if(res.code==200){
...
//分页组件
const pagination = ref({currentPage: 1, pageSize: 24, videoId: route.params.videoId});
 ...
 * 发布/回复 评论
 */
import { getparentNameById, postAddCommentApi } from "@/api/get/getInfo";
